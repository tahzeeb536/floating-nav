...
!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
      ? (module.exports = t(require("ControlKit"), require("THREE"), require("gsap")))
      : "function" == typeof define && define.amd
      ? define("Shery", ["ControlKit", "THREE", "gsap"], t)
      : "object" == typeof exports
      ? (exports.Shery = t(require("ControlKit"), require("THREE"), require("gsap")))
  ...
  (() => {
      ...
      return (
          (() => {
              "use strict";
              a.r(o), a.d(o, { ScrollPos: () => Er, default: () => kr, hoverWithMediaCircle: () => xr, imageEffect: () => Cr, imageMasker: () => _r, makeMagnet: () => yr, mouseFollower: () => gr, textAnimate: () => br });
              var e = {};
              a.r(e), a.d(e, { ScrollPos: () => Er, hoverWithMediaCircle: () => xr, imageEffect: () => Cr, imageMasker: () => _r, makeMagnet: () => yr, mouseFollower: () => gr, textAnimate: () => br });
              var t = a(163),
                  n = a.n(t),
                  r = a(824),
                  i = a(919),
              ...
              var z,
                  ...
                  Ye = function (e) {
                      ...
                      for (n = e.length; n--; ) (e[n] && (e[n]._gsap || (e[n]._gsap = new _n(e[n], t)))) || e.splice(n, 1);
                      return e;
                  },
                  He = function (e) {
                  ...
                  Je = function () {
                      var e,
                          ...
                          n = Le.length,
                          r = Le.slice(0);
                      for (ze = {}, Le.length = 0, e = 0; e < n; e++) (t = r[e]) && t._lazy && (t.render(t._lazy[0], t._lazy[1], !0)._lazy = 0);
                  },
                  $e = function (e, t, n, r) {
                      Le.length && !B && Je(), e.render(t, n, r || (B && t < 0 && (e._initted || e._startAt))), Le.length && !B && Je();
                  },
                  et = function (e) {
                      var t = parseFloat(e);
                  ...
                  it = function e(t, n) {
                      for (var r in n) "__proto__" !== r && "constructor" !== r && "prototype" !== r && (t[r] = ve(n[r]) ? e(t[r] || (t[r] = {}), n[r]) : n[r]);
                      return t;
                  },
                  at = function (e, t) {
                      var n,
                  ...
                  ot = function (e) {
                      var t,
                          ...
                          r = e.keyframes
                              ...
                              : nt;
                      if (pe(e.inherit)) for (; n; ) r(e, n.vars.defaults), (n = n.parent || n._dp);
                      return e;
                  },
                  ...
                  gt = function (e, t) {
                      var n = e._dp;
                      return n && n.smoothChildTiming && e._ts && ((e._start = We(n._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts))), mt(e), n._dirty || ct(n, e)), e;
                  },
                  _t = function (e, t) {
                      var n;
                      if (
                          ((t._time || (!t._dur && t._initted) || (t._start < e._time && (t._dur || !t.add))) && ((n = ft(e.rawTime(), t)), (!t._dur || At(0, t.totalDuration(), n) - t._tTime > ne) && t.render(n, !0)),
                  ...
                  xt = function (e, t, n, r, i) {
                      return Cn(e, t, i), e._initted ? (!n && e._pt && !B && ((e._dur && !1 !== e.vars.lazy) || (!e._dur && e.vars.lazy)) && G !== an.frame ? (Le.push(e), (e._lazy = [i, r]), 1) : void 0) : 1;
                  },
                  St = function e(t) {
                      var n = t.parent;
                  ...
                  wt = function (e, t, n, r) {
                      var i = e._repeat,
                          ...
                          o = e._tTime / e._tDur;
                      return (
                          o && !r && (e._time *= a / e._dur), (e._dur = a), (e._tDur = i ? (i < 0 ? 1e10 : We(a * (i + 1) + e._rDelay * i)) : a), o > 0 && !r && gt(e, (e._tTime = e._tDur * o)), e.parent && mt(e), n || ct(e.parent, e), e
                      );
                  },
                  Mt = function (e) {
                  ...
                  Et = function e(t, n, r) {
                      ...
                      return ue(n) && (isNaN(n) || n in s)
                          ? ((a = n.charAt(0)),
                            ...
                            (i = n.indexOf("=")),
                            "<" === a || ">" === a
                                ? (i >= 0 && (n = n.replace(/=/, "")), ("<" === a ? l._start : l.endTime(l._repeat >= 0)) + (parseFloat(n.substr(1)) || 0) * (o ? (i < 0 ? l : r).totalDuration() / 100 : 1))
                                : i < 0
                                ? (n in s || (s[n] = u), s[n])
                                : ((a = parseFloat(n.charAt(i - 1) + n.substr(i + 1))), o && r && (a = (a / 100) * (_e(r) ? r[0] : r).totalDuration()), i > 1 ? e(t, n.substr(0, i - 1), r) + a : u + a))
                          : null == n
                          ? u
                          : +n;
                  },
                  kt = function (e, t, n) {
                      ...
                      if ((a && (s.duration = t[1]), (s.parent = n), e)) {
                          for (r = s, i = n; i && !("immediateRender" in r); ) (r = i.vars.defaults || {}), (i = pe(i.vars.inherit) && i.parent);
                          (s.immediateRender = pe(r.immediateRender)), e < 2 ? (s.runBackwards = 1) : (s.startAt = t[o - 1]);
                      }
                  ...
                  zt = function (e) {
                      ...
                      var t = ve(e) ? e : { each: e },
                          ...
                          c = r;
                      return (
                          ue(r) ? (u = c = { center: 0.5, edges: 0.5, end: 1 }[r] || 0) : !o && s && ((u = r[0]), (c = r[1])),
                          function (e, o, d) {
                              var h,
                                  v,
                                  p,
                              ...
                              if (!S) {
                                  ...
                                  for (S = a[x] = [], h = s ? Math.min(b, x) * u - 0.5 : r % b, v = b === te ? 0 : s ? (x * c) / b - 0.5 : (r / b) | 0, _ = 0, y = te, g = 0; g < x; g++)
                                      (p = (g % b) - h), (f = v - ((g / b) | 0)), (S[g] = m = l ? Math.abs("y" === l ? f : p) : oe(p * p + f * f)), m > _ && (_ = m), m < y && (y = m);
                                  "random" === r && Lt(S),
                                      (S.max = _ - y),
                                      (S.min = y),
                              ...
                              return (x = (S[e] - S.min) / S.max || 0), We(S.b + (n ? n(x) : x) * S.v) + S.u;
                          }
                      );
                  },
                  Bt = function (e) {
                  ...
                  Nt = function (e, t) {
                      var n,
                          ...
                          i = _e(e);
                      return (
                          !i && ve(e) && ((n = i = e.radius || te), e.values ? ((e = Ft(e.values)), (r = !de(e[0])) && (n *= n)) : (e = Bt(e.increment))),
                          Dt(
                              t,
                              i
                                  ? ce(e)
                                      ...
                                      : function (t) {
                                            for (var i, a, o = parseFloat(r ? t.x : t), s = parseFloat(r ? t.y : 0), l = te, u = 0, c = e.length; c--; )
                                                (i = r ? (i = e[c].x - o) * i + (a = e[c].y - s) * a : Math.abs(e[c] - o)) < l && ((l = i), (u = c));
                                            return (u = !n || l <= n ? e[u] : t), r || u === t || de(t) ? u : u + Rt(t);
                                        }
                                  : Bt(e)
                          )
                      );
                  ...
                  Vt = function (e, t, n, r) {
                      return Dt(_e(e) ? !t : !0 === n ? !!(n = 0) : !r, function () {
                          return _e(e) ? e[~~(Math.random() * e.length)] : (n = n || 1e-5) && (r = n < 1 ? Math.pow(10, (n + "").length - 2) : 1) && Math.floor(Math.round((e - n / 2 + Math.random() * (t - e + 0.99 * n)) / n) * n * r) / r;
                      });
                  },
                  jt = function (e, t, n) {
                  ...
                  Kt = function (e) {
                      for (var t, n, r, i, a = 0, o = ""; ~(t = e.indexOf("random(", a)); )
                          (r = e.indexOf(")", t)), (i = "[" === e.charAt(t + 7)), (n = e.substr(t + 7, r - t - 7).match(i ? we : ye)), (o += e.substr(a, t - a) + Vt(i ? n : +n[0], i ? 0 : +n[1], +n[2] || 1e-5)), (a = r + 1);
                  ...
                  Gt = function (e, t, n) {
                      var r,
                          ...
                          l = N,
                          u = e._ctx;
                      if (s) return (r = o[t + "Params"]), (i = o.callbackScope || e), n && Le.length && Je(), u && (N = u), (a = r ? s.apply(i, r) : s.call(i)), (N = l), a;
                  },
                  Xt = function (e) {
                      return ut(e), e.scrollTrigger && e.scrollTrigger.kill(!!B), e.progress() < 1 && Gt(e, "onInterrupt"), e;
                  },
                  Ut = [],
                  Wt = function (e) {
                      if (fe() && e) {
                          var t = (e = (!e.name && e.default) || e).name,
                              ...
                              r =
                                  t && !n && e.init
                                      ...
                                      : e,
                              i = { init: Pe, render: Nn, add: wn, kill: jn, modifier: Vn, rawVars: 0 },
                              a = { targetTest: 0, get: 0, getSetter: In, aliases: {}, register: 0 };
                          if ((on(), e !== r)) {
                              if (Be[t]) return;
                              nt(r, nt(at(e, i), a)), rt(r.prototype, rt(i, at(e, a))), (Be[(r.prop = t)] = r), e.targetTest && (je.push(r), (Ie[t] = 1)), (t = ("css" === t ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin");
                          }
                  ...
                  Jt = function (e, t, n) {
                      return ((6 * (e += e < 0 ? 1 : e > 1 ? -1 : 0) < 1 ? t + (n - t) * e * 6 : e < 0.5 ? n : 3 * e < 2 ? t + (n - t) * (2 / 3 - e) * 6 : t) * Zt + 0.5) | 0;
                  },
                  $t = function (e, t, n) {
                      var r,
                          i,
                      ...
                      if (!v) {
                          if (("," === e.substr(-1) && (e = e.substr(0, e.length - 1)), Qt[e])) v = Qt[e];
                          else if ("#" === e.charAt(0)) {
                              ...
                              if (((v = h = e.match(ye)), t)) {
                                  if (~e.indexOf("=")) return (v = e.match(be)), n && v.length < 4 && (v[3] = 1), v;
                              } else
                                  (o = (+v[0] % 360) / 360),
                                      (s = +v[1] / 100),
                                      (r = 2 * (l = +v[2] / 100) - (i = l <= 0.5 ? l * (s + 1) : l + s - l * s)),
                                      v.length > 3 && (v[3] *= 1),
                                      (v[0] = Jt(o + 1 / 3, r, i)),
                                      (v[1] = Jt(o, r, i)),
                                      (v[2] = Jt(o - 1 / 3, r, i));
                      ...
                      return (
                          t &&
                              ...
                              u === c ? (o = s = 0) : ((d = u - c), (s = l > 0.5 ? d / (2 - u - c) : d / (u + c)), (o = u === r ? (i - a) / d + (i < a ? 6 : 0) : u === i ? (a - r) / d + 2 : (r - i) / d + 4), (o *= 60)),
                              (v[0] = ~~(o + 0.5)),
                              (v[1] = ~~(100 * s + 0.5)),
                              (v[2] = ~~(100 * l + 0.5))),
                          n && v.length < 4 && (v[3] = 1),
                  ...
                  tn = function (e, t, n) {
                      ...
                      if (
                          ...
                          for (o = (i = e.replace(nn, "1").split(xe)).length - 1; c < o; c++) s += i[c] + (~r.indexOf(c) ? l.shift() || u + "0,0,0,0)" : (a.length ? a : l.length ? l : n).shift());
                      if (!i) for (o = (i = e.split(nn)).length - 1; c < o; c++) s += i[c] + l[c];
                      return s + i[o];
                  },
                  nn = (function () {
                      var e,
                  ...
                  an = (function () {
                      var e,
                          ...
                          p = function n(p) {
                              var f,
                                  ...
                                  y = o() - c,
                                  b = !0 === p;
                              if ((y > s && (u += y - l), ((f = (g = (c += y) - u) - h) > 0 || b) && ((_ = ++r.frame), (i = g - 1e3 * r.time), (r.time = g /= 1e3), (h += f + (f >= d ? 4 : d - f)), (m = 1)), b || (e = t(n)), m))
                      ...
                      return (r = {
                          ...
                          sleep: function () {
                              (n ? j.cancelAnimationFrame : clearTimeout)(e), (U = 0), (t = Pe);
                          },
                  ...
                  cn = function (e) {
                      for (var t, n, r, i = {}, a = e.substr(1, e.length - 3).split(":"), o = a[0], s = 1, l = a.length; s < l; s++)
                          (n = a[s]), (t = s !== l - 1 ? n.lastIndexOf(",") : n.length), (r = n.substr(0, t)), (i[o] = isNaN(r) ? r.replace(un, "").trim() : +r), (o = n.substr(t + 1).trim());
                      return i;
                  },
                  dn = function (e) {
                      return function (t) {
                  ...
                  hn = function e(t, n) {
                      for (var r, i = t._first; i; )
                          i instanceof bn ? e(i, n) : !i.vars.yoyoEase || (i._yoyo && i._repeat) || i._yoyo === n || (i.timeline ? e(i.timeline, n) : ((r = i._ease), (i._ease = i._yEase), (i._yEase = r), (i._yoyo = n))), (i = i._next);
                  },
                  vn = function (e, t) {
                      return (
                          (e &&
                                    ...
                                    (function (e) {
                                        ...
                                        return o && a.length > 1 && o.config
                                            ? o.config.apply(
                                                  ...
                                                  ~e.indexOf("{")
                                                      ? [cn(a[1])]
                                                      : ((t = e), (n = t.indexOf("(") + 1), (r = t.indexOf(")")), (i = t.indexOf("(", n)), t.substring(n, ~i && i < r ? t.indexOf(")", r + 1) : r)).split(",").map(et)
                                              )
                                            : sn._CE && ln.test(e)
                                            ? sn._CE("", e)
                                            : o;
                  ...
                  pn = function (e, t, n, r) {
                      ...
                      return (
                          Xe(e, function (e) {
                              for (var t in ((sn[e] = Ce[e] = a), (sn[(i = e.toLowerCase())] = n), a)) sn[i + ("easeIn" === t ? ".in" : "easeOut" === t ? ".out" : ".inOut")] = sn[e + "." + t] = a[t];
                          }),
                          a
                      );
                  },
              ...
              Xe("Linear,Quad,Cubic,Quart,Quint,Strong", function (e, t) {
                  ...
                  pn(
                      ...
                      (J = function (e) {
                          return e < Q ? W * e * e : e < 0.7272727272727273 ? W * Math.pow(e - 1.5 / Z, 2) + 0.75 : e < 0.9090909090909092 ? W * (e -= 2.25 / Z) * e + 0.9375 : W * Math.pow(e - 2.625 / Z, 2) + 0.984375;
                      })
                  ),
                  pn("Expo", function (e) {
              ...
              var _n = function (e, t) {
                      (this.id = ae++), (e._gsap = this), (this.target = e), (this.harness = t), (this.get = t ? t.get : Ge), (this.set = t ? t.getSetter : In);
                  },
                  yn = (function () {
                      function e(e) {
                          (this.vars = e),
                      ...
                      return (
                          ...
                          (t.totalTime = function (e, t) {
                              ...
                              if (n && n.smoothChildTiming && this._ts) {
                                  for (gt(this, e), !n._dp || n.parent || _t(n, this); n && n.parent; )
                              ...
                              return (
                                  (this._tTime !== e || (!this._dur && !t) || (this._initted && Math.abs(this._zTime) === ne) || (!e && !this._initted && (this.add || this._ptLookup))) && (this._ts || (this._pTime = e), $e(this, e, t)),
                                  this
                              );
                          }),
                          (t.time = function (e, t) {
                          ...
                          (t.startTime = function (e) {
                              if (arguments.length) {
                                  ...
                                  return t && (t._sort || !this.parent) && yt(t, this, e - this._delay), this;
                              }
                              return this._start;
                          }),
                          ...
                          (t.revert = function (e) {
                              void 0 === e && (e = Fe);
                              var t = B;
                              return (B = e), (this._initted || this._startAt) && (this.timeline && this.timeline.revert(e), this.totalTime(-0.01, e.suppressEvents)), "nested" !== this.data && !1 !== e.kill && this.kill(), (B = t), this;
                          }),
                          ...
                          (t.repeat = function (e) {
                              return arguments.length ? ((this._repeat = e === 1 / 0 ? -2 : e), Mt(this)) : -2 === this._repeat ? 1 / 0 : this._repeat;
                          }),
              ...
              nt(yn.prototype, { _time: 0, _start: 0, _end: 0, _tTime: 0, _tDur: 0, _dirty: 0, _repeat: 0, _yoyo: !1, parent: null, _initted: !1, _rDelay: 0, _ts: 1, _dp: 0, ratio: 0, _zTime: -1e-8, _prom: 0, _ps: !1, _rts: 1 });
              var bn = (function (e) {
                  function t(t, n) {
                      var r;
                      return (
                  ...
                  return (
                      ...
                      (n.set = function (e, t, n) {
                          return (t.duration = 0), (t.parent = this), ot(t).repeatDelay || (t.repeat = 0), (t.immediateRender = !!t.immediateRender), new Rn(e, t, Et(this, n), 1), this;
                      }),
                      (n.call = function (e, t, n) {
                          return yt(this, Rn.delayedCall(0, e, t), n);
                      }),
                      (n.staggerTo = function (e, t, n, r, i, a, o) {
                          return (n.duration = t), (n.stagger = n.stagger || r), (n.onComplete = a), (n.onCompleteParams = o), (n.parent = this), new Rn(e, n, Et(this, i)), this;
                      }),
                      (n.staggerFrom = function (e, t, n, r, i, a, o) {
                          return (n.runBackwards = 1), (ot(n).immediateRender = pe(n.immediateRender)), this.staggerTo(e, t, n, r, i, a, o);
                      }),
                      (n.staggerFromTo = function (e, t, n, r, i, a, o, s) {
                          return (r.startAt = n), (ot(r).immediateRender = pe(r.immediateRender)), this.staggerTo(e, t, r, i, a, o, s);
                      }),
                      (n.render = function (e, t, n) {
                          ...
                          if ((this !== V && _ > m && e >= 0 && (_ = m), _ !== this._tTime || n || y)) {
                              if ((f !== this._time && g && ((_ += this._time - f), (e += this._time - f)), (r = _), (d = this._start), (l = !(c = this._ts)), y && (g || (f = this._zTime), (e || !t) && (this._zTime = e)), this._repeat)) {
                                  if (((v = this._yoyo), (s = g + this._rDelay), this._repeat < -1 && e < 0)) return this.totalTime(100 * s + e, t, n);
                                  if (
                                      ((r = We(_ % s)),
                                      _ === m ? ((o = this._repeat), (r = g)) : ((o = ~~(_ / s)) && o === _ / s && ((r = g), o--), r > g && (r = g)),
                                      (h = pt(this._tTime, s)),
                                      ...
                                      if (
                                          ...
                                          return this;
                                      if (((g = this._dur), (m = this._tDur), x && ((this._lock = 2), (f = b ? g : -1e-4), this.render(f, !0), this.vars.repeatRefresh && !p && this.invalidate()), (this._lock = 0), !this._ts && !l))
                                          return this;
                                      hn(this, p);
                                  }
                              }
                              if (
                                  ...
                                  !f && r && !t && !o && (Gt(this, "onStart"), this._tTime !== _))
                              )
                                  return this;
                              if (r >= f && e >= 0)
                                  for (i = this._first; i; ) {
                                  ...
                                  for (var S = e < 0 ? e : r; i; ) {
                                      if (((a = i._prev), (i._act || S <= i._end) && i._ts && u !== i)) {
                                          if (i.parent !== this) return this.render(e, t, n);
                                          if (
                                              (i.render(i._ts > 0 ? (S - i._start) * i._ts : (i._dirty ? i.totalDuration() : i._tDur) + (S - i._start) * i._ts, t, n || (B && (i._initted || i._startAt))),
                              ...
                              if (u && !t && (this.pause(), (u.render(r >= f ? 0 : -1e-8)._zTime = r >= f ? 1 : -1), this._ts)) return (this._start = d), mt(this), this.render(e, t, n);
                              this._onUpdate && !t && Gt(this, "onUpdate", !0),
                                  ((_ === m && this._tTime >= this.totalDuration()) || (!_ && f)) &&
                                      ((d !== this._start && Math.abs(c) === Math.abs(this._ts)) ||
                                          this._lock ||
                                          ((e || !g) && ((_ === m && this._ts > 0) || (!_ && this._ts < 0)) && ut(this, 1),
                                          t || (e < 0 && !f) || (!_ && !f && m) || (Gt(this, _ === m && e >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(_ < m && this.timeScale() > 0) && this._prom())));
                          }
                          return this;
                      }),
                      (n.add = function (e, t) {
                      ...
                      (n.getChildren = function (e, t, n, r) {
                          void 0 === e && (e = !0), void 0 === t && (t = !0), void 0 === n && (n = !0), void 0 === r && (r = -te);
                          for (var i = [], a = this._first; a; ) a._start >= r && (a instanceof Rn ? t && i.push(a) : (n && i.push(a), e && i.push.apply(i, a.getChildren(!0, t, n)))), (a = a._next);
                          return i;
                      }),
                      ...
                      (n.remove = function (e) {
                          return ue(e) ? this.removeLabel(e) : ce(e) ? this.killTweensOf(e) : (lt(this, e), e === this._recent && (this._recent = this._last), ct(this));
                      }),
                      ...
                      (n.addPause = function (e, t, n) {
                          ...
                          return (r.data = "isPause"), (this._hasPause = 1), yt(this, r, Et(this, e));
                      }),
                      (n.removePause = function (e) {
                          var t = this._first;
                          for (e = Et(this, e); t; ) t._start === e && "isPause" === t.data && ut(t), (t = t._next);
                      }),
                      ...
                      (n.getTweensOf = function (e, t) {
                          for (var n, r = [], i = Ft(e), a = this._first, o = de(t); a; )
                              a instanceof Rn
                                  ? Qe(a._targets, i) && (o ? (!xn || (a._initted && a._ts)) && a.globalTime(0) <= t && a.globalTime(a.totalDuration()) > t : !t || a.isActive()) && r.push(a)
                                  ...
                                  nt(
                                      {
                                          ...
                                          onStart: function () {
                                              if ((r.pause(), !n)) {
                                                  ...
                                                  c._dur !== e && wt(c, e, 0, 1).render(c._time, !0, !0), (n = 1);
                                              }
                                              s && s.apply(c, l || []);
                                          },
                                      },
                          ...
                          if (a._dirty) {
                              for (r = a.parent; o; )
                                  (t = o._prev),
                                      ...
                                      (n = o._start) > s && a._sort && o._ts && !a._lock ? ((a._lock = 1), (yt(a, o, n - o._delay, 1)._lock = 0)) : (s = n),
                                      n < 0 && o._ts && ((i -= n), ((!r && !a._dp) || (r && r.smoothChildTiming)) && ((a._start += n / a._ts), (a._time -= n), (a._tTime -= n)), a.shiftChildren(-n, !1, -Infinity), (s = 0)),
                                      o._end > i && o._ts && (i = o._end),
                                      (o = t);
                              wt(a, a === V && a._time > i ? a._time : i, 1, 1), (a._dirty = 0);
                          }
                          return a._tDur;
                      }),
                      (t.updateRoot = function (e) {
                          if ((V._ts && ($e(V, ft(e, V)), (G = an.frame)), an.frame >= Ve)) {
                              Ve += $.autoSleep || 120;
                              var t = V._first;
              ...
              var xn,
                  ...
                  Tn = function (e, t, n, r, i, a, o) {
                      var s,
                          ...
                          m = 0,
                          g = 0;
                      for (f.b = n, f.e = r, n += "", (v = ~(r += "").indexOf("random(")) && (r = Kt(r)), a && (a((p = [n, r]), e, t), (n = p[0]), (r = p[1])), l = n.match(Se) || []; (s = Se.exec(r)); )
                          (c = s[0]),
                              (d = r.substring(m, s.index)),
                              u ? (u = (u + 1) % 5) : "rgba(" === d.substr(-5) && (u = 1),
                              c !== l[g++] &&
                                  ((h = parseFloat(l[g - 1]) || 0),
                                  (f._pt = { _next: f._pt, p: d || 1 === g ? d : ",", s: h, c: "=" === c.charAt(1) ? Ze(h, c) - h : parseFloat(c) - h, m: u && u < 4 ? Math.round : 0 }),
                                  (m = Se.lastIndex));
                      return (f.c = m < r.length ? r.substring(m, r.length) : ""), (f.fp = o), (Te.test(r) || v) && (f.e = 0), (this._pt = f), f;
                  },
                  wn = function (e, t, n, r, i, a, o, s, l, u) {
                      ce(r) && (r = r(i || 0, e, a));
                      var c,
                          d = e[t],
                          h = "get" !== n ? n : ce(d) ? (l ? e[t.indexOf("set") || !ce(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](l) : e[t]()) : d,
                          v = ce(d) ? (l ? qn : On) : Pn;
                      if ((ue(r) && (~r.indexOf("random(") && (r = Kt(r)), "=" === r.charAt(1) && ((c = Ze(h, r) + (Rt(h) || 0)) || 0 === c) && (r = c)), !u || h !== r || Sn))
                          return isNaN(h * r) || "" === r
                              ? (!d && !(t in e) && De(t, r), Tn.call(this, e, t, h, r, v, s || $.stringFilter, l))
                              : ((c = new Hn(this._pt, e, t, +h || 0, r - (h || 0), "boolean" == typeof d ? zn : Ln, 0, v)), l && (c.fp = l), o && c.modifier(o, this, e), (this._pt = c));
                  },
                  Mn = function (e, t, n, r, i, a) {
                      ...
                      if (
                          ...
                          !1 !==
                              (o = new Be[e]()).init(
                                  ...
                                  o.rawVars
                                      ? t[e]
                                      : (function (e, t, n, r, i) {
                                            if ((ce(e) && (e = kn(e, i, t, n, r)), !ve(e) || (e.style && e.nodeType) || _e(e) || ge(e))) return ue(e) ? kn(e, i, t, n, r) : e;
                                            var a,
                                                o = {};
                          ...
                          ((n._pt = s = new Hn(n._pt, i, e, 0, 1, o.render, o, 0, o.priority)), n !== X)
                      )
                          for (l = n._ptLookup[n._targets.indexOf(i)], u = o._props.length; u--; ) l[o._props[u]] = s;
                      return o;
                  },
                  Cn = function e(t, n, r) {
                      var i,
                      ...
                      if (
                          ...
                          if (((f = (d = R[0] ? He(R[0]).harness : 0) && g[d.prop]), (i = at(g, Ie)), A && (A._zTime < 0 && A.progress(1), n < 0 && M && b && !k ? A.render(-1, !0) : A.revert(M && D ? qe : Oe), (A._lazy = 0)), y)) {
                              if (
                                  (ut(
                                      (t._startAt = Rn.set(
                                          R,
                                          nt({ data: "isStart", overwrite: !1, parent: P, immediateRender: !0, lazy: !A && pe(x), startAt: null, delay: 0, onUpdate: S, onUpdateParams: T, callbackScope: w, stagger: 0 }, y)
                                      ))
                                  ),
                                  (t._startAt._dp = 0),
                                  (t._startAt._sat = t),
                              ...
                              if (
                                  (n && (b = !1),
                                  (o = nt({ overwrite: !1, data: "isFromStart", lazy: b && !A && pe(x), immediateRender: b, stagger: 0, parent: P }, i)),
                                  f && (o[d.prop] = f),
                          ...
                          for (t._pt = t._ptCache = 0, x = (D && pe(x)) || (x && !D), a = 0; a < R.length; a++) {
                              if (
                                  ...
                                  d &&
                                      ...
                                      ((t._pt = s = new Hn(t._pt, l, h.name, 0, 1, h.render, h, 0, h.priority)),
                                  ...
                                  for (o in i) Be[o] && (h = Mn(o, i, t, p, l, O)) ? h.priority && (u = 1) : (v[o] = s = wn.call(t, l, o, "get", i[o], p, O, 0, g.stringFilter));
                              t._op && t._op[a] && t.kill(l, t._op[a]), q && t._pt && ((xn = t), V.killTweensOf(l, v, t.globalTime(n)), (m = !t.parent), (xn = 0)), t._pt && x && (ze[c.id] = 1);
                          }
                          u && Yn(t), t._onInit && t._onInit(t);
                      }
                      (t._onUpdate = S), (t._initted = (!t._op || t._pt) && !m), E && n <= 0 && F.render(te, !0, !0);
                  },
                  En = function (e, t, n, r) {
                      var i,
                          a,
                      ...
                      else for (i in t) (a = n[i] || (n[i] = [])), "ease" === i || a.push({ t: parseFloat(e), v: t[i], e: o });
                  },
              ...
              var Rn = (function (e) {
                  function t(t, n, r, i) {
                      ...
                      if (((a._targets = M.length ? Ye(M) : Ae("GSAP target " + t + " not found. https://greensock.com", !$.nullTargetWarn) || []), (a._ptLookup = []), (a._overwrite = y), b || _ || me(f) || me(m))) {
                          if (
                              ((n = a.vars), (o = a.timeline = new bn({ data: "nested", defaults: x || {}, targets: w && "nested" === w.data ? w.vars.targets : M })).kill(), (o.parent = o._dp = I(a)), (o._start = 0), _ || me(f) || me(m))
                          ) {
                              if (((u = M.length), (h = _ && zt(_)), ve(_))) for (c in _) ~Dn.indexOf(c) && (v || (v = {}), (v[c] = _[c]));
                              for (s = 0; s < u; s++)
                                  ((l = at(n, An)).stagger = 0),
                                      T && (l.yoyoEase = T),
                                      v && rt(l, v),
                                      ...
                                      !_ && 1 === u && l.delay && ((a._delay = m = l.delay), (a._start += m), (l.delay = 0)),
                                      o.to(d, l, h ? h(s, d, M) : 0),
                                      (o._ease = sn.none);
                              o.duration() ? (f = m = 0) : (a.timeline = 0);
                          } else if (b) {
                              ot(nt(o.vars.defaults, { ease: "none" })), (o._ease = vn(b.ease || n.ease || "none"));
                              var C,
                                  E,
                                  k,
                                  D = 0;
                              if (_e(b))
                                  ...
                                  for (c in ((l = {}), b)) "ease" === c || "easeEach" === c || En(c, b[c], l, b.easeEach);
                                  for (c in l)
                                      for (
                                          ...
                                          ((k = { ease: (E = C[s]).e, duration: ((E.t - (s ? C[s - 1].t : 0)) / 100) * f })[c] = E.v), o.to(M, k, D), (D += k.duration);
                      ...
                      return (
                          ...
                          n.paused && a.paused(!0),
                          (g || (!f && !b && a._start === We(w._time) && pe(g) && ht(I(a)) && "nested" !== w.data)) && ((a._tTime = -1e-8), a.render(Math.max(0, -m) || 0)),
                          S && bt(I(a), S),
                          a
                      );
                  }
                          ...
                          if (p) {
                              if (m !== this._tTime || !e || n || (!this._initted && this._tTime) || (this._startAt && this._zTime < 0 !== f)) {
                                  if (((r = m), (c = this.timeline), this._repeat)) {
                                      if (((o = p + this._rDelay), this._repeat < -1 && f)) return this.totalTime(100 * o + e, t, n);
                                      if (
                                          ((r = We(m % o)),
                                          m === v ? ((a = this._repeat), (r = p)) : ((a = ~~(m / o)) && a === m / o && ((r = p), a--), r > p && (r = p)),
                                          (l = this._yoyo && 1 & a) && ((d = this._yEase), (r = p - r)),
                                          (s = pt(this._tTime, o)),
                                          r === h && !n && this._initted)
                                      )
                                          return (this._tTime = m), this;
                                      a !== s && (c && this._yEase && hn(c, l), !this.vars.repeatRefresh || l || this._lock || ((this._lock = n = 1), (this.render(We(o * a), !0).invalidate()._lock = 0)));
                                  }
                                  if (!this._initted) {
                                      if (xt(this, f ? e : r, n, t, m)) return (this._tTime = 0), this;
                                  ...
                                  (c && c.render(e < 0 ? e : !r && l ? -1e-8 : c._dur * c._ease(r / this._dur), t, n)) || (this._startAt && (this._zTime = e)),
                                      ...
                                      (m !== this._tDur && m) ||
                                          ...
                                          t || (f && !h) || !(m || h || l) || (Gt(this, m === v ? "onComplete" : "onReverseComplete", !0), this._prom && !(m < v && this.timeScale() > 0) && this._prom()));
                              }
                          } else
                              !(function (e, t, n, r) {
                                  var i,
                                      ...
                                      o,
                                      s = e.ratio,
                                      l = t < 0 || (!t && ((!e._start && St(e) && (e._initted || !Tt(e))) || ((e._ts < 0 || e._dp._ts < 0) && !Tt(e)))) ? 0 : 1,
                                      u = e._rDelay,
                                      c = 0;
                                  if (
                                      (u && e._repeat && ((c = At(0, e._tDur, t)), (a = pt(c, u)), e._yoyo && 1 & a && (l = 1 - l), a !== pt(e._tTime, u) && ((s = 1 - l), e.vars.repeatRefresh && e._initted && e.invalidate())),
                                      l !== s || B || r || e._zTime === ne || (!t && e._zTime))
                                  ) {
                                      if (!e._initted && xt(e, t, r, n, c)) return;
                                      for (o = e._zTime, e._zTime = t || (n ? ne : 0), n || (n = t && !o), e.ratio = l, e._from && (l = 1 - l), e._time = 0, e._tTime = c, i = e._pt; i; ) i.r(l, i.d), (i = i._next);
                                      t < 0 && dt(e, t, 0, !0),
                                          e._onUpdate && !n && Gt(e, "onUpdate"),
                                          c && e._repeat && !n && e.parent && Gt(e, "onRepeat"),
                                          (t >= e._tDur || t < 0) && e.ratio === l && (l && ut(e, 1), n || B || (Gt(e, l ? "onComplete" : "onReverseComplete", !0), e._prom && e._prom()));
                              ...
                              (function (e, t, n, r, i, a, o) {
                                  ...
                                  if (!d)
                                      for (d = e._ptCache[t] = [], u = e._ptLookup, c = e._targets.length; c--; ) {
                                          if ((s = u[c][t]) && s.d && s.d._pt) for (s = s.d._pt; s && s.p !== t && s.fp !== t; ) s = s._next;
                                          if (!s) return (Sn = 1), (e.vars[t] = "+=0"), Cn(e, o), (Sn = 0), 1;
                                          d.push(s);
                                      }
                                  for (c = d.length; c--; ) ((s = (l = d[c])._pt || l).s = (!r && 0 !== r) || i ? s.s + (r || 0) + a * s.c : r), (s.c = n - s.s), l.e && (l.e = Ue(n) + Rt(l.e)), l.b && (l.b = s.s + Rt(l.b));
                              })(this, e, t, n, r, this._ease(i / this._dur), i)
                                  ? this.resetTo(e, t, n, r)
                                  : (gt(this, 0), this.parent || st(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0))
                          );
                      }),
                      (n.kill = function (e, t) {
                          ...
                          if (this.timeline) {
                              ...
                              return this.timeline.killTweensOf(e, t, xn && !0 !== xn.vars.overwrite)._first || Xt(this), this.parent && n !== this.timeline.totalDuration() && wt(this, (this._dur * this.timeline._tDur) / n, 0, 1), this;
                          }
                          var r,
                              i,
                              a,
                          ...
                          for (
                                  ...
                                  "all" !== t &&
                                      ...
                                      (t = (function (e, t) {
                                          var n,
                                              ...
                                              s = o && o.aliases;
                                          if (!s) return t;
                                          for (r in ((n = rt({}, t)), s)) if ((r in n)) for (i = (a = s[r].split(",")).length; i--; ) n[a[i]] = n[r];
                                          return n;
                                      })(c, t))),
                                  u = c.length;
                              u--;
                              ...
                              if (~d.indexOf(c[u]))
                                  for (s in ((i = h[u]), "all" === t ? ((r[u] = t), (o = i), (a = {})) : ((a = r[u] = r[u] || {}), (o = t)), o))
                                      (l = i && i[s]) && (("kill" in l.d && !0 !== l.d.kill(s)) || lt(this, l, "_pt"), delete i[s]), "all" !== a && (a[s] = 1);
              ...
              nt(Rn.prototype, { _targets: [], _lazy: 0, _startAt: 0, _op: 0, _onInit: 0 }),
              ...
              var Pn = function (e, t, n) {
                  ...
                  jn = function (e) {
                      for (var t, n, r = this._pt; r; ) (n = r._next), (r.p === e && !r.op) || r.op === e ? lt(this, r, "_pt") : r.dep || (t = 1), (r = n);
                      return !t;
                  },
                  Kn = function (e, t, n, r) {
                  ...
                  Hn = (function () {
                      function e(e, t, n, r, i, a, o, s, l) {
                          (this.t = t), (this.s = r), (this.c = i), (this.p = n), (this.r = a || Ln), (this.d = o || this), (this.set = s || Pn), (this.pr = l || 0), (this._next = e), e && (e._prev = this);
                      }
                      return (
              ...
              Xe(
                  ...
                  (V = new bn({ sortChildren: !1, defaults: ee, autoRemoveChildren: !0, id: "root", smoothChildTiming: !0 })),
                  ($.stringFilter = function (e) {
                      var t,
                          n = e.join(" ");
                      if (((nn.lastIndex = 0), nn.test(n))) return (t = rn.test(n)), (e[1] = tn(e[1], t)), (e[0] = tn(e[0], t, en(e[1]))), !0;
                  });
              var Gn = [],
                  Xn = {},
                  Un = [],
                      ...
                      e - Wn > 2 &&
                          ...
                          Gn.forEach(function (e) {
                              var n,
                                  ...
                                  o = e.queries,
                                  s = e.conditions;
                              for (r in o) (n = j.matchMedia(o[r]).matches) && (i = 1), n !== s[r] && ((s[r] = n), (a = 1));
                  ...
                  $n = (function () {
                      function e(e, t) {
                          (this.selector = t && It(t)), (this.data = []), (this._r = []), (this.isReverted = !1), (this.id = Zn++), e && this.add(e);
                      }
                      var t = e.prototype;
                      return (
                              ...
                              var r = this,
                                  i = function () {
                                      var e,
                                          i = N,
                                          a = r.selector;
                                      return i && i !== r && i.data.push(r), n && (r.selector = It(n)), (N = r), (e = t.apply(r, arguments)), ce(e) && r._r.push(e), (N = i), (r.selector = a), (r.isReverted = !1), e;
                                  };
                          ...
                          (t.kill = function (e, t) {
                              ...
                              if ((this.clear(), t)) for (var i = Gn.length; i--; ) Gn[i].id === this.id && Gn.splice(i, 1);
                          }),
                          (t.revert = function (e) {
                              this.kill(e || {});
                          }),
                      ...
                      return (
                          (t.add = function (e, t, n) {
                              ...
                              var r,
                                  ...
                                  s = (o.conditions = {});
                              for (i in (N && !o.selector && (o.selector = N.selector), this.contexts.push(o), (t = o.add("onMatch", t)), (o.queries = e), e))
                                  "all" === i ? (a = 1) : (r = j.matchMedia(e[i])) && (Gn.indexOf(o) < 0 && Gn.push(o), (s[i] = r.matches) && (a = 1), r.addListener ? r.addListener(Jn) : r.addEventListener("change", Jn));
                              return a && t(o), this;
                          }),
                          (t.revert = function (e) {
                              this.kill(e || {});
                  ...
                  tr = {
                      ...
                      quickSetter: function (e, t, n) {
                          ...
                          var a = Be[t],
                              ...
                              l = a
                                  ? function (t) {
                                        var r = new a();
                                        (X._pt = 0), r.init(e, n ? t + n : t, X, 0, [e]), r.render(1, r), X._pt && Nn(1, X);
                                    }
                                  : o.set(e, s);
                          return a
                              ? l
                      ...
                      quickTo: function (e, t, n) {
                          var r,
                              i = ir.to(e, rt((((r = {})[t] = "+=0.1"), (r.paused = !0), r), n || {})),
                              a = function (e, n, r) {
                      ...
                      defaults: function (e) {
                          return e && e.ease && (e.ease = vn(e.ease, ee.ease)), it(ee, e || {});
                      },
                      config: function (e) {
                          return it($, e || {});
                      },
                      ...
                      exportRoot: function (e, t) {
                          ...
                          var n,
                              r,
                              i = new bn(e);
                          for (i.smoothChildTiming = pe(e.smoothChildTiming), V.remove(i), i._dp = 0, i._time = i._tTime = V._time, n = V._first; n; )
                              (r = n._next), (!t && !n._dur && n instanceof Rn && n.vars.onComplete === n._targets[0]) || yt(i, n, n._start - n._delay), (n = r);
                          return yt(V, i, 0), i;
                      },
                              ...
                              r._onInit = function (e) {
                                  ...
                                  !(function (e, t) {
                                      var n,
                                          ...
                                          i,
                                          a = e._targets;
                                      for (n in t) for (r = a.length; r--; ) (i = e._ptLookup[r][n]) && (i = i.d) && (i._pt && (i = nr(i, n)), i && i.modifier && i.modifier(t[n], e, a[r], n));
                                  })(e, n);
                              };
                          },
                      };
              ...
              (Rn.version = bn.version = ir.version = "3.12.2"), (H = 1), fe() && on();
              sn.Power0;
              var ar = sn.Power1,
                  or = sn.Power2,
                  sr = (sn.Power3, sn.Power4, sn.Linear, sn.Quad, sn.Cubic, sn.Quart, sn.Quint, sn.Strong, sn.Elastic, sn.Back, sn.SteppedEase, sn.Bounce, sn.Sine, sn.Expo),
                  lr = sn.Circ;
              const ur = (e, t, n) => e * (1 - n) + t * n,
                  cr = () => {
                      ...
                      document.querySelector(e) && document.querySelectorAll(e).forEach((e, t) => (e.style.width = 3 != t ? "30%" : "50%")),
                          document.querySelector(t) && ((document.querySelector(t).parentElement.style.float = "none"), (document.querySelector(t).parentElement.style.width = "100% ")),
              ...
              const pr = (e, t, i, a, { attributes: o, camera: s, renderer: l, width: u, height: c, scene: d, geometry: h, opts: v, effect: p = 0 } = {}) => {
                  ...
                  if (e.getAttribute("src"))
                      if ("video" === e.nodeName.toLowerCase()) {
                          ...
                          (e.crossOrigin = "anonymous"), (e.src = x[0]), (e.muted = !0), (e.loop = !0), (e.preload = !0), e.play(), (T[0] = e);
                      } else {
                          const e = new Image();
                  ...
                  const M = () => {
                      if ("img" !== e.nodeName.toLowerCase() && !v.slideStyle) {
                          w.update(), (w.dampen = 0.9 + ((e, t = 1, n = 10) => Math.min(Math.max(e, t), n))(v.damping || 7, 0, 9) / 100), (w.speed = Math.abs(v.scrollSpeed || 6)), (w.touchSpeed = Math.abs(v.touchSpeed || 6));
                          let e = Math.floor((w.scrollPos + 0.5 * g) / g) * g;
                          v.scrollSnapping && w.snap(e);
                          let { scrollPos: t } = w;
                          t < 0 && (t = 0), t > 0 && t < g * (S.length - 1) && (a.currentScroll.value = t / g);
                      }
                  };
                  if ("img" !== e.nodeName.toLowerCase()) {
                      ...
                      for (let t = 0; t < e.children.length; t++)
                          if (((x[t] = e.children[t].getAttribute("src")), (S[t] = new r.TextureLoader().load(x[t])), t > 0 && (e.children[t].style.display = "none"), "video" === e.children[t].nodeName.toLowerCase())) {
                              const e = document.createElement("video");
                              (e.crossOrigin = "anonymous"), (e.src = x[t]), (e.muted = !0), (e.loop = !0), (e.preload = !0), e.play(), (T[t] = e);
                          } else {
                              const e = new Image();
                  ...
                  Object.assign(a, {
                      ...
                      scrollType: { value: 0 },
                      uIntercept: { value: 0 },
                      geoVertex: { range: [1, 64], value: a.geoVertex ? a.geoVertex.value : 1 },
                      ...
                      uTexture: { value: "img" === e.nodeName.toLowerCase() ? S : [S[0], S[1]] },
                  });
                  const C =
                      ...
                      k = new r.Mesh(h, E);
                  k.scale.set(m, g), dr(k, a.geoVertex.value), (k.visible = !1), d.add(k);
                  var D = {
                          backgroundImage: "",
                          shapePosition: [0, 0],
                          shapeScaleX: 0.5,
                          ...
                          Resolution_XY: { value: 1e3, range: [0, 1e3], precise: 1, rangep: [0, 100] },
                      ...
                      R = null;
                  const P = (e) => {
                      (e = JSON.parse(JSON.stringify(e))), Object.assign(a, e), e.color && (e.color.value = new r.Color(e.color.value)), Object.assign(a, e), (document.querySelector("._canvas_container").style.zIndex = a.zindex.value);
                  };
                  v.preset &&
                      fetch(v.preset)
                          .then((e) => e.json())
                      ...
                      v.debug &&
                          ...
                          (A = new (F())()),
                          !0 === v.gooey &&
                              A.addPanel({ enable: !1, label: "Gooey Panel", width: 300, fixed: !1, position: [20, 50] })
                                  .addSubGroup({ label: "InfiniteGooey", enable: !1 })
                                  .addCheckbox(a.infiniteGooey, "value", { label: "Enable" })
                                  .addSlider(a.growSize, "value", "range", { label: "Grow Size", step: 0.001 })
                                  .addSlider(a.durationOut, "value", "range", { label: "Duration Out", step: 0.001 })
                                  .addSlider(a.durationIn, "value", "range", { label: "Duration In", step: 0.001 })
                                  .addGroup()
                                  .addCheckbox(a.noEffectGooey, "value", { label: "GooeyBakEffect" })
                                  .addSlider(a.noise_speed, "value", "range", { label: "Speed", step: 0.001 })
                                  .addSlider(a.metaball, "value", "range", { label: "GooeyBall", step: 0.001 })
                                  .addSlider(a.discard_threshold, "value", "range", { label: "Threshold", step: 0.001 })
                                  .addSlider(a.antialias_threshold, "value", "range", { label: "Antialias", step: 0.001 })
                                  .addSlider(a.noise_height, "value", "range", { label: "Height", step: 0.001 })
                                  .addSlider(a.noise_scale, "value", "range", { label: "Scale", step: 0.001 }),
                          (R = A.addPanel({ enable: !1, label: "Debug Panel", fixed: !1, position: [20, 10], width: 300 })
                              ...
                              .addStringInput(a.zindex, "value", { label: "Canvas Z-Index", step: 1, onChange: () => (document.querySelector("._canvas_container").style.zIndex = a.zindex.value) })
                              .addSubGroup({ label: "Shape Control", enable: !1 })
                              .addCheckbox(a.ignoreShapeAspect, "value", { label: "Ignore Shape Aspect" })
                              .addSlider(a.shapeRadius, "value", "range", { label: "Radius", step: 0.001 })
                              .addSlider(a.shapeEdgeSoftness, "value", "range", { label: "Edge Softness", step: 0.001 })
                              .addSlider(D, "shapeScaleX", "shapeScaleR", { label: "Scale X", step: 0.001, onChange: () => (a.shapeScale.value.x = D.shapeScaleX) })
                              .addSlider(D, "shapeScaleY", "shapeScaleR", { label: "Scale Y", step: 0.001, onChange: () => (a.shapeScale.value.y = D.shapeScaleY) })
                              .addPad(D, "shapePosition", { label: "Shape Position", onChange: () => a.shapePosition.value.set(...D.shapePosition) })
                              .addGroup()),
                          (document.querySelector("body #controlKit .panel .button, #controlKit .picker .button").style.color = "#8c92a4"),
                          "img" !== e.nodeName.toLowerCase() && 1 != v.gooey && R.addSelect(D, "scrollType", { target: "scrollTypeIs", label: "Scroll Type", onChange: (e) => (a.scrollType.value = e) }),
                          R.addCheckbox(a.masker, "value", { label: "Image Zoomer" }).addSlider(a.maskVal, "value", "range", { label: "Zoom level", step: 1e-5 }));
                  ...
                  const L = (e) => {
                      ...
                      t.length > 0 ? ((q = t[0].uv), (y.x = 2 * t[0].uv.x - 1), (y.y = 2 * -t[0].uv.y - 1), I || (I = !0)) : I && (I = !1);
                  };
                  document.addEventListener("mousemove", L), document.addEventListener("wheel", L);
                  let z = !1,
                      B = 0;
                  function N(e) {
                      return e % x.length;
                  ...
                  e.addEventListener("mousedown", (e) => {
                      0 == e.button &&
                          ...
                          n().to(a.metaball, {
                              ...
                              onComplete: () => {
                                  B++, (a.metaball.value = 0), (z = !1), (a.uTexture.value = [S[N(B)], S[N(B + 1)]]), n().to(a.metaball, { value: V, ease: sr.easeInOut, duration: a.durationIn.value });
                              },
                          });
                  }),
                  ...
                  const j = () => {
                      ...
                      new r.Box3().setFromObject(k).getSize(t),
                          (function (e, t, n = []) {
                                          ...
                                          new Promise((a, o) => {
                                              if ("video" === e.nodeName.toLowerCase())
                                                  e.onloadedmetadata = () => {
                                                      ...
                                                      (t.minFilter = r.LinearFilter), (t.magFilter = r.LinearFilter), a(t);
                                                  };
                                              else {
                                                  function s() {
                                                      const o = e.width,
                                                      ...
                                                      let l,
                                                          ...
                                                          c = 0,
                                                          d = 0;
                                                      o / s > t ? ((l = s * t), (u = s), (c = (o - l) / 2)) : ((l = o), (u = o / t), (d = (s - u) / 2));
                                                      const h = document.createElement("canvas");
                                                      (h.width = l), (h.height = u);
                                                      h.getContext("2d").drawImage(e, c, d, l, u, 0, 0, l, u), n[i] && n[i].dispose();
                              ...
                              .then((e) => {
                                  (e.minFilter = r.LinearFilter), (e.magFilter = r.LinearFilter), (k.material.uniforms.uTexture.value = e), (S = e), (k.visible = !0);
                              })
                              .catch((e) => {
                  ...
                  let K = !1;
                  j(), setTimeout(window.dispatchEvent(new Event("resize")), 0), addEventListener("resize", j);
                  const Y = new r.Clock();
                  return (
                      o.uniforms.push(a),
                      o.meshes.push(k),
                      {
                          ...
                          animate: function t() {
                              (k.position.y = -e.getBoundingClientRect().top + c / 2 - e.getBoundingClientRect().height / 2),
                                  ...
                                  l.render(d, s),
                                  Object.assign(a, { time: { value: Y.getElapsedTime() }, mouse: { value: y }, mousem: { value: b } }),
                                  (a.mousei.value.x = r.MathUtils.lerp(a.mousei.value.x, q.x, 0.07)),
                                  (a.mousei.value.y = r.MathUtils.lerp(a.mousei.value.y, q.y, 0.07)),
                                  (v.gooey && !v.slideStyle) ||
                                      ((e) => {
                                          if (a.currentScroll.value >= 0) {
                                              (a.uScroll.value = r.MathUtils.lerp(a.uScroll.value, a.currentScroll.value, e)), (a.uSection.value = Math.floor(a.uScroll.value));
                                              var t = a.uSection.value;
                                              S.length > t && (S.length > t + 1 ? (a.uTexture.value = [S[t], S[t + 1]]) : (a.uTexture.value = [S[S.length - 1], S[S.length - 1]]));
                                          }
                                      })(a.scrollLerp.value),
                                  z || (a.uIntercept.value = r.MathUtils.lerp(a.uIntercept.value, I ? 1 : 0, 0.07)),
                                  (_ = e.getBoundingClientRect().left),
                                  (m = e.getBoundingClientRect().width),
                                  (g = e.getBoundingClientRect().height),
                                  k.scale.set(e.getBoundingClientRect().width, e.getBoundingClientRect().height),
              ...
              var fr = null,
                  mr = null;
              function gr(e = {}) {
                  (fr = document.createElement("div")), (mr = document.createElement("div")), fr.classList.add("mousefollower"), mr.classList.add("mousefollower"), (mr.id = "behindmouse");
                  var t = 0,
                      r = 0;
                  addEventListener("mousemove", function (i) {
                      e.skew && ((r = n().utils.clamp(15, 35, i.clientX - t)), (t = i.clientX), n().to(".mousefollower", { width: r + "px", ease: e.ease || sr.easeOut, duration: e.duration || 1 })),
                          n().to(".mousefollower", { top: i.clientY, left: i.clientX, duration: e.duration || 1, ease: e.ease || sr.easeOut });
                  }),
                      addEventListener("mouseenter", function () {
                          n().to(".mousefollower", { opacity: 1 });
                      }),
                      addEventListener("mouseleave", function () {
                          n().to(".mousefollower", { opacity: 0, duration: e.duration || 1, ease: e.ease || sr.easeOut });
                      }),
              ...
              function _r(e = "img", t = {}) {
                  document.querySelectorAll(e).forEach(function (e) {
                      ...
                      if (t.mouseFollower) {
                          ...
                          (a.style.width = n().utils.clamp(50, 70, 0.3 * e.getBoundingClientRect().width) + "px"),
                              (a.style.height = n().utils.clamp(50, 70, 0.3 * e.getBoundingClientRect().width) + "px"),
                              (a.textContent = t.text || "View More"),
                              a.classList.add("circle"),
                              i.addEventListener("mousemove", function (e) {
                                  i.appendChild(a), n().to(a, { top: e.clientY - i.getBoundingClientRect().y, left: e.clientX - i.getBoundingClientRect().x, ease: sr.easeOut, duration: 2 });
                              }),
                      ...
                      i.classList.add("mask"),
                          ...
                          i.addEventListener("mouseenter", function () {
                              n().to(fr, { opacity: 0, ease: n().EasePower1 }), n().to(mr, { opacity: 0, ease: n().EasePower1 }), n().to(a, { opacity: 1, ease: sr.easeOut, duration: 0.8 });
                          }),
                          i.addEventListener("mousemove", function (r) {
                              n().to(e, { scale: t.scale || e.getBoundingClientRect().width < 450 ? 1.05 : 1.025, ease: t.ease || sr.easeOut, duration: t.duration || 0.7 });
                          }),
                          i.addEventListener("mouseleave", function () {
                              n().to(fr, { opacity: 1, ease: ar }), n().to(mr, { opacity: 1, ease: ar }), n().to(this.childNodes[0], { scale: 1, ease: t.ease || sr.easeOut, duration: t.duration || 1 });
                          });
                  });
              }
              function yr(e, t = {}) {
                  document.querySelectorAll(e).forEach(function (e) {
                      e.addEventListener("mousemove", function (r) {
                          ...
                          n().to(".mousefollower", { scale: 4, ease: or, duration: 0.5 }), n().to(e, { x: ur(-20, 20, a), y: ur(-20, 20, o), duration: t.duration || 1, ease: t.ease || sr.easeOut });
                      }),
                          e.addEventListener("mouseleave", function (r) {
                              n().to(".mousefollower", { scale: 1, ease: or, duration: 0.5 }), n().to(e, { x: 0, y: 0, duration: t.duration || 1, ease: t.ease || sr.easeOut });
                          });
                  });
              }
              function br(e, t = {}) {
                  ...
                  switch (
                      (r.forEach(function (e) {
                          (e.textContent = e.textContent.trim().replaceAll(" ", " ")), e.classList.add("sheryelem");
                          var t = "";
                      ...
                      case 1:
                          r.forEach(function (e) {
                              n().from(e.childNodes, { scrollTrigger: { trigger: e, start: "top 80%" }, y: t.y || 10, stagger: t.delay || 0.1, opacity: 0, duration: t.duration || 2, ease: t.ease || sr.easeOut });
                          });
                          break;
                      case 2:
                          r.forEach(function (e, r) {
                              var i = e.childNodes.length - 1;
                              for (r = 0; r < e.childNodes.length / 2; r++) e.childNodes[r].dataset.delay = r;
                              for (r = Math.floor(e.childNodes.length / 2); r < e.childNodes.length; r++) e.childNodes[r].dataset.delay = i - r;
                              e.childNodes.forEach(function (e) {
                                  n().from(e, { y: 20, delay: e.dataset.delay * (t.multiplier || 0.1), opacity: 0, ease: t.ease || sr.easeOut });
                              });
                          });
                          break;
                      default:
              ...
              function xr(e, t) {
                  ...
                  a.classList.add("just-a-white-blend-screen"), a.classList.add("movercirc");
                      ...
                      document.querySelectorAll(e).forEach(function (e, i) {
                          ...
                          e.classList.add("hovercircle"),
                              ...
                              e.addEventListener("mousemove", function (e) {
                                  var t = n().utils.pipe(n().utils.clamp(-1, 1), n().utils.mapRange(-1, 1, 0.8, 1.2)),
                                      r = (t(e.clientX - l), t(e.clientY - u));
                                  (l = e.clientX),
                                      (u = e.clientY),
                                      clearTimeout(a),
                                      (a = setTimeout(function () {
                                          n().to(".movercirc", { transform: "translate(-50%,-50%)" });
                                      }, 500)),
                                      n().to(".movercirc", { left: e.clientX, top: e.clientY, width: "20vw", height: "20vw", transform: `translate(-50%,-50%) scale(${r})`, ease: lr, duration: 0.4, opacity: 1 }),
                                      o.classList.add("blend");
                              }),
                              e.addEventListener("mouseleave", function (e) {
                                  n().to(".movercirc", { width: "0", height: "0", ease: or, duration: 0.4, opacity: 0 }), o.classList.remove("blend");
                              });
                      });
              }
              var Sr,
              ...
              function Cr(e = "img", t = {}) {
                  ...
                  null == Sr &&
                      ((Sr = new r.Scene()),
                      ((Tr = new r.PerspectiveCamera(70, n / i, 0.01, 1e3)).fov = 2 * Math.atan(i / 2 / 10) * (180 / Math.PI)),
                      Tr.position.set(0, 0, 10),
                      (wr = new r.WebGLRenderer({ antialias: !0, alpha: !0 })).setSize(n, i),
                      ...
                      document.body.appendChild(Mr));
                  const o = { geometry: a, scene: Sr, camera: Tr, renderer: wr, uniforms: [], meshes: [] };
                  document.querySelectorAll(e).forEach(function (e) {
                      switch (((e.style.opacity = "0"), t.style || 1)) {
                          case 1:
                              var { debugObj: l, panel: c, uniforms: h, animate: p } = pr(
                                  e,
                                  s(),
                                  u(),
                                  { a: { value: 2, range: [0, 30] }, b: { value: 0.7, range: [-1, 1] } },
                                  { camera: Tr, attributes: o, renderer: wr, width: n, height: i, scene: Sr, geometry: a, effect: 1, opts: t, offset: -0.04 }
                              );
                              c &&
                                  (c
                                      .addSelect(l, "onMouse", { target: "Active", label: "Effect Mode", onChange: (e) => (h.onMouse.value = e) })
                                      .addSlider(h.a, "value", "range", { label: "Speed", step: 0.001 })
                                      .addSlider(h.b, "value", "range", { label: "Wobbliness", step: 0.001 }),
                                  cr()),
                                  p();
                              break;
                          case 2:
                              var { debugObj: l, controlKit: m, panel: c, uniforms: h, animate: p } = pr(
                                  e,
                                  d(),
                                  v(),
                                  {
                                  ...
                                  { camera: Tr, attributes: o, renderer: wr, width: n, height: i, scene: Sr, geometry: a, effect: 2, opts: t }
                              );
                              c &&
                                  (c
                                      .addCheckbox(h.distortion, "value", { label: "Distortion Effect" })
                                      .addSelect(l, "onMouse", { target: "Active", label: "Effect Mode", onChange: (e) => (h.onMouse.value = e) })
                                      .addSelect(l, "Mode", { target: "Mode Active", label: "Blend/Overlay Mode", onChange: (e) => (h.mode.value = e - 10) })
                                      .addSelect(l, "Mouse", { target: "Mouse Active", label: "Mousemove Effect", onChange: (e) => (h.mousemove.value = e) })
                                      .addSelect(l, "Trigo", { target: "Trig A", label: "Effect StyleA", onChange: (e) => (h.modeA.value = e) })
                                      .addSelect(l, "Trigo", { target: "Trig N", label: "Effect StyleN", onChange: (e) => (h.modeN.value = e) })
                                      .addColor(l, "Color", { colorMode: "hex", onChange: (e) => h.color.value.set(e) }),
                                  m
                                      .addPanel({ enable: !1, label: "Controls Panel", width: 350, fixed: !1, position: [20, t.debug ? 90 : 50] })
                                      .addSlider(l.speed, "normal", "range", { label: "Speed", step: 1e-5, onChange: () => (h.speed.value = l.speed.normal) })
                                      .addSlider(l.speed, "precise", "rangep", { label: "Speed Precise", step: 1e-5, onChange: () => (h.speed.value = l.speed.precise) })
                                      .addSlider(l.frequency, "normal", "range", { label: "Frequency", step: 1e-5, onChange: () => (h.frequency.value = l.frequency.normal) })
                                      .addSlider(l.frequency, "precise", "rangep", { label: "Frequency Precise", step: 1e-5, onChange: () => (h.frequency.value = l.frequency.precise) })
                                      ...
                                      .addSlider(h.angle, "value", "range", { label: "Angle", step: 1e-5 })
                                      .addSlider(h.waveFactor, "value", "range", { label: "Wave Factor", step: 1e-5 })
                                      .addSlider(l.pixelStrength, "normal", "range", { label: "Pixel Strength", step: 1e-5, onChange: () => (h.pixelStrength.value = l.pixelStrength.normal) })
                                      .addSlider(l.pixelStrength, "precise", "rangep", { label: "Precise Pixel", step: 1e-5, onChange: () => (h.pixelStrength.value = l.pixelStrength.normal) })
                                      .addSlider(h.quality, "value", "range", { label: "Quality", step: 1e-5 })
                                      .addSlider(h.contrast, "value", "range", { label: "Contrast", step: 1e-5 })
                                      .addSlider(h.brightness, "value", "range", { label: "Brightness", step: 1e-5 })
                                      .addSlider(h.colorExposer, "value", "range", { label: "Color Exposer", step: 1e-5 })
                                      .addSlider(l.strength, "normal", "range", { label: "Strength", step: 1e-5, onChange: (e) => (h.strength.value = l.strength.normal) })
                                      .addSlider(l.strength, "precise", "rangep", { label: "Strength Precise", step: 1e-5, onChange: (e) => (h.strength.value = l.strength.precise) })
                                      .addSlider(h.exposer, "value", "range", { label: "Exposer", step: 1e-5 }),
                                  cr()),
                                  p();
                              break;
                          case 3:
                              var { debugObj: l, panel: c, elemMesh: _, uniforms: h, animate: p } = pr(
                                  e,
                                  f(),
                                  g(),
                                  { uFrequencyX: { value: 12, range: [0, 100] }, uFrequencyY: { value: 12, range: [0, 100] }, uFrequencyZ: { value: 10, range: [0, 100] }, geoVertex: { value: 32, range: [1, 64] } },
                                  { camera: Tr, attributes: o, renderer: wr, width: n, height: i, scene: Sr, geometry: a, effect: 3, opts: t, fov: 1.0375, size: 0.01744, offset: -0.04 }
                              );
                              c &&
                                  (c
                                      .addSelect(l, "onMouse", { target: "Active", label: "Effect Mode", onChange: (e) => (h.onMouse.value = e) })
                                      ...
                                      .addSlider(h.uFrequencyX, "value", "range", { label: "FrequencyX", step: 0.01 })
                                      .addSlider(h.uFrequencyY, "value", "range", { label: "FrequencyY", step: 0.01 })
                                      .addSlider(h.uFrequencyZ, "value", "range", { label: "FrequencyZ", step: 0.01 }),
                                  cr()),
                                  p();
                              break;
                          case 4:
                              var { debugObj: l, panel: c, elemMesh: _, uniforms: h, animate: p } = pr(
                                  ...
                                  { camera: Tr, attributes: o, renderer: wr, width: n, height: i, scene: Sr, geometry: a, effect: 4, opts: t, offset: -0.04 }
                              );
                              t.config && Object.keys(t.config).forEach((e) => (h[e].value = t.config[e].value)),
                                  c &&
                                      (c
                                          ...
                                          .addSelect(l, "onMouse", { target: "Active", label: "Effect Mode", onChange: (e) => (h.onMouse.value = e) })
                                          .addSlider(h.geoVertex, "value", "range", { label: "VertexCount", step: 1, onChange: () => dr(_, h.geoVertex.value) })
                                          .addSlider(l, "s", "range", { label: "Speed", onChange: () => (h.uSpeed.value = l.s), step: 0.01 })
                                          .addSlider(l, "f", "rangep", { label: "FastForward", onChange: () => (h.uSpeed.value = l.f), step: 0.01 })
                                          .addSlider(h.uAmplitude, "value", "range", { label: "Amplitude", step: 0.01 })
                                          .addSlider(h.uFrequency, "value", "range", { label: "Frequency", step: 0.01 }),
                                      cr()),
                                  p();
                              break;
                          case 5:
                              var { debugObj: l, panel: c, uniforms: h, animate: p } = pr(
                                  ...
                                  T(),
                                  M(),
                                  { a: { value: 2, range: [0, 30] }, b: { value: 1 / 1.333, range: [-1, 1] } },
                                  { camera: Tr, attributes: o, renderer: wr, width: n, height: i, scene: Sr, geometry: a, effect: 5, opts: t, fov: 0.9, onDoc: !0, offset: -0.04 }
                              );
                              c &&
                                  (c
                                      .addSelect(l, "onMouse", { target: "Active", label: "Effect Mode", onChange: (e) => (h.onMouse.value = e) })
                          ...
                          case 6:
                              var { debugObj: l, panel: c, uniforms: h, animate: p } = pr(
                                  ...
                                  E(),
                                  D(),
                                  { noiseDetail: { value: 7.44, range: [0, 100] }, distortionAmount: { value: 2.98, range: [0, 10] }, scale: { value: 36.36, range: [0, 100] }, speed: { value: 0.79, range: [0, 1] } },
                                  { camera: Tr, attributes: o, renderer: wr, width: n, height: i, scene: Sr, geometry: a, effect: 6, opts: t }
                              );
                              c &&
                                  (c
                                      .addSlider(h.speed, "value", "range", { label: "speed", step: 0.001 })
                                      .addSlider(h.scale, "value", "range", { label: "scale", step: 0.001 })
                                      .addSlider(h.distortionAmount, "value", "range", { label: "Amount", step: 0.001 })
                                      .addSlider(h.noiseDetail, "value", "range", { label: "noiseDetail", step: 0.001 }),
                                  cr()),
                                  p();
                              break;
                          case 7:
                              var { debugObj: l, panel: c, uniforms: h, animate: p } = pr(
                                  ...
                                  { camera: Tr, attributes: o, renderer: wr, width: n, height: i, scene: Sr, geometry: a, effect: 7, opts: t }
                              );
                              c &&
                                  (c
                                      .addCheckbox(h.invert, "value", { label: "Invert" })
                                      .addCheckbox(h.autorotate, "value", { label: "Auto Rotate" })
                                      .addCheckbox(h.mouseMove, "value", { label: "Mouse Effect" })
                                      .addSlider(h.mouseMoveEWX, "value", "range", { label: "EWX", step: 0.001 })
                                      .addSlider(h.mouseMoveEHY, "value", "range", { label: "EHY", step: 0.001 })
                                      .addSlider(h.rotation, "value", "range", { label: "Rotation", step: 0.001 })
                                      .addSlider(h.scale, "value", "range", { label: "Scale", step: 0.001 })
                                      .addSlider(h.pattern, "value", "range", { label: "Pattern", step: 0.001 })
                                      .addSlider(h.density, "value", "range", { label: "Density", step: 0.001 })
                                      .addSlider(h.clustering, "value", "range", { label: "Clustering", step: 0.001 })
                                      .addSlider(h.gapping, "value", "range", { label: "Gapping", step: 0.001 })
                                      .addSlider(h.smoothness, "value", "range", { label: "Smoothness", step: 0.001 })
                                      .addSlider(h.styling, "value", "range", { label: "Styling", step: 0.001 })
                                      .addSlider(h.circular, "value", "range", { label: "Ring Contrast", step: 0.001 })
                                      .addColor(l, "Color", { colorMode: "hex", onChange: (e) => h.color.value.set(e) })
                                      .addStringInput(l, "backgroundImage", {
                                          label: "Effect Background Image Source",
                                          onChange: () => {
                                              "" == l.backgroundImage ? (h.isTexture.value = !1) : (h.isTexture.value = !0), (h.uTexture.value[2] = new r.TextureLoader().load(l.backgroundImage));
                                          },
                                      }),
                                  cr()),
                                  p();
              ...
              class Er {
                  constructor() {
                      (this.acceleration = 0),
                          ...
                          window.addEventListener("touchmove", (e) => {
                              ...
                              this.accelerate(Math.sign(t) * this.touchSpeed), (this.lastDelta = e.targetTouches[0].clientY);
                          }),
                          ...
                          window.addEventListener("mousemove", (e) => {
                              if (this.mouseDown) {
                                  ...
                                  this.accelerate(Math.sign(t) * this.touchSpeed * 0.4), (this.lastDelta = e.clientY);
                              }
                          }),
                  ...
                  update() {
                      (this.velocity += this.acceleration),
                          Math.abs(this.velocity) > this.velocityThreshold ? ((this.velocity *= this.dampen), (this.scrollPos += this.velocity), (this.scrollPos = this.scrollPos >= 0 ? this.scrollPos : 0)) : (this.velocity = 0),
                          Math.abs(this.velocity) > this.maxSpeed && (this.velocity = Math.sign(this.velocity) * this.maxSpeed),
                          (this.acceleration = 0);
                  }
                  snap(e, t = 100, n = 1.5) {
                      Math.abs(e - this.scrollPos) < t && (this.velocity *= this.dampen), Math.abs(this.velocity) < this.velocityThreshold + n && (this.scrollPos += 0.1 * (e - this.scrollPos));
                  }
                  project(e = 1) {
                      if (1 === e) return this.scrollPos + this.velocity * this.dampen;
                      for (var t = this.scrollPos, n = this.velocity, r = 0; r < e; r++) t += n *= this.dampen;
                      return t;
                  }
              }
              const kr = e;
